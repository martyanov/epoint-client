...
from epoint.client.gpg import GPG
from epoint.client.http import urlfetch, HTTPError
from epoint.client.protocol import parse_message, strip_signature, extract_signature
from epoint.client.protocol import TemplateError

log = logging.getLogger('epoint.client.document')
...
class DocumentSource(object):
    ...
    def fetch(self):
        try:
            ...
            log.error("Error during fetching the document: %s" % e)
            return None
